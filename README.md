...
export PREVIEW_NAMESPACE=$APP_NAME-develop

export JENKINS_X_DOCKER_REGISTRY_SERVICE_HOST=https://$DOCKER_REGISTRY
...
cd ./charts/preview
make build
jx preview --app $APP_NAME --namespace $PREVIEW_NAMESPACE --dir ../..
